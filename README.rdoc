...
Example: ensure IS is started, install TNS_7.1.2_Fix4 packages, then restart
  ...
  webmethadone --url http://localhost:5555 --user Administrator --password manage -s webMethodsIntegrationServer_7.1 --start
  ...
  webmethadone --url http://localhost:5555 --user Administrator --password manage -s webMethodsIntegrationServer_7.1 --restart
